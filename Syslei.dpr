...
uses
  ...
  Syslei.Conversions.Lote.ObjectListDataSet.FireDAC in 'Source\Conversions\Syslei.Conversions.Lote.ObjectListDataSet.FireDAC.pas' {ObjectListLoteDataSetConverter: TDataModule},
  Syslei.Conversions.Lote.Venda.ObjectListDataSet.FireDAC in 'Source\Conversions\Syslei.Conversions.Lote.Venda.ObjectListDataSet.FireDAC.pas' {ObjectListVendaLoteDataSetConverter: TDataModule},
  Syslei.Conversions.Proprio.ObjectListDataSet.FireDAC in 'Source\Conversions\Syslei.Conversions.Proprio.ObjectListDataSet.FireDAC.pas' {ObjectListProprioDataSetConverter: TDataModule},
  Syslei.Models.Domains.Lote.Filter in 'Source\Models\Domains\Syslei.Models.Domains.Lote.Filter.pas',
  Syslei.Models.Domains.Lote.Filter.Helpers in 'Source\Models\Domains\Syslei.Models.Domains.Lote.Filter.Helpers.pas',
  Syslei.Models.Domains.Lote.Venda.Filter in 'Source\Models\Domains\Syslei.Models.Domains.Lote.Venda.Filter.pas',
  Syslei.Models.Domains.Lote.Venda.Filter.Helpers in 'Source\Models\Domains\Syslei.Models.Domains.Lote.Venda.Filter.Helpers.pas',
  Syslei.Models.Entities.Lote in 'Source\Models\Entities\Syslei.Models.Entities.Lote.pas',
  Syslei.Models.Entities.Lote.Helpers in 'Source\Models\Entities\Syslei.Models.Entities.Lote.Helpers.pas',
  ...
  Syslei.Models.Finders.Lote.Filter in 'Source\Models\Finders\Syslei.Models.Finders.Lote.Filter.pas',
  Syslei.Models.Finders.Lote.Venda.Filter in 'Source\Models\Finders\Syslei.Models.Finders.Lote.Venda.Filter.pas',
